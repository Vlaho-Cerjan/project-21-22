import type {VenueUserData, VenueUserGroupData} from '@/types/venues';

const venuesGroupData: VenueUserGroupData[] = Array.from(
  {length: 30},
  (_, i) => ({
    id: 'Group_' + (i + 1),
    name: `Group ${i + 1}`,
...
const venuesPaginationData: VenueUserData[] = Array.from(
  {length: 30},
  (_, i) => ({
    id: 'Venues_' + (i + 1),
    name: `Venue ${i + 1}`,
...
const venuesGroupListData: VenueUserData[] = Array.from(
  {length: 30},
  (_, i) => ({
    id: 'GroupVenues_' + (i + 1),
    name: `Venue ${i + 1}`,
...
describe('Business Venues', () => {
  beforeEach(() => {
    cy.intercept(
      'GET',
      `${Cypress.env('Project_API')}api/group/list?limit=100&offset=0&search=`,
      {
        success: true,
        data: {
    ...
    cy.intercept(
      'GET',
      `${Cypress.env('Project_API')}api/venue/list?limit=10&offset=0&order_by=name&direction=asc&status=2`,
      {
        success: true,
        data: {
    ...
    cy.intercept(
      'GET',
      `${Cypress.env('Project_API')}api/venue/list?limit=10&offset=10&order_by=name&direction=asc&status=2`,
      {
        success: true,
        data: {
          total: venuesPaginationData.length,
    ...
    cy.intercept(
      'GET',
      `${Cypress.env('Project_API')}api/venue/list?limit=10&offset=20&order_by=name&direction=asc&status=2`,
      {
        success: true,
        data: {
          total: venuesPaginationData.length,
    ...
    cy.intercept(
      'GET',
      `${Cypress.env('Project_API')}api/venue/list?limit=10&offset=0&order_by=name&direction=asc&status=1`,
      {
        success: true,
        data: {
          total: venuesPaginationData.length,
          venues: [...venuesPaginationData].slice(0, 10).map((venue) => ({
            ...venue,
            status: 1,
          })),
        },
    ...
    cy.intercept(
      'GET',
      `${Cypress.env('Project_API')}api/venue/list?limit=10&offset=10&order_by=name&direction=asc&status=1`,
      {
        success: true,
        data: {
          total: venuesPaginationData.length,
          venues: [...venuesPaginationData].slice(10, 20).map((venue) => ({
            ...venue,
            status: 1,
          })),
        },
      },
    ).as('getVenuesPending2');

    cy.intercept(
      'GET',
      `${Cypress.env('Project_API')}api/venue/list?limit=10&offset=20&order_by=name&direction=asc&status=1`,
      {
        success: true,
        data: {
          total: venuesPaginationData.length,
          venues: [...venuesPaginationData].slice(20, 30).map((venue) => ({
            ...venue,
            status: 1,
          })),
        },
      },
    ).as('getVenuesPending3');

    cy.intercept(
      'GET',
      `${Cypress.env('Project_API')}api/group/list?limit=9&offset=0&order_by=name&direction=asc&status=2`,
      {
        success: true,
        data: {
          total: venuesGroupData.length,
    ...
    cy.intercept(
      'GET',
      `${Cypress.env('Project_API')}api/group/list?limit=10&offset=9&order_by=name&direction=asc&status=2`,
      {
        success: true,
        data: {
          total: venuesGroupData.length,
    ...
    cy.intercept(
      'GET',
      `${Cypress.env('Project_API')}api/group/list?limit=10&offset=19&order_by=name&direction=asc&status=2`,
      {
        success: true,
        data: {
          total: venuesGroupData.length,
    ...
    cy.intercept(
      'GET',
      `${Cypress.env('Project_API')}api/group/list?limit=9&offset=0&order_by=name&direction=asc&status=1`,
      {
        success: true,
        data: {
          total: venuesGroupData.length,
    ...
    ).as('getVenuePendingGroups');

    cy.intercept(
      'GET',
      `${Cypress.env('Project_API')}api/group/list?limit=10&offset=9&order_by=name&direction=asc&status=1`,
      {
        success: true,
        data: {
          total: venuesGroupData.length,
    ...
    ).as('getVenuePendingGroups2');

    cy.intercept(
      'GET',
      `${Cypress.env('Project_API')}api/group/list?limit=10&offset=19&order_by=name&direction=asc&status=1`,
      {
        success: true,
        data: {
          total: venuesGroupData.length,
    ...
    ).as('getVenuePendingGroups3');

    cy.intercept(
      'GET',
      `${Cypress.env('Project_API')}api/venue/list?group_id=${venuesGroupData[0]?.id}&limit=10&offset=0&order_by=name&direction=asc&status=2`,
      {
        success: true,
        data: {
    ...
    cy.intercept(
      'GET',
      `${Cypress.env('Project_API')}api/venue/list?group_id=${venuesGroupData[0]?.id}&limit=10&offset=10&order_by=name&direction=asc&status=2`,
      {
        success: true,
        data: {
          total: venuesGroupListData.length,
    ...
    cy.intercept(
      'GET',
      `${Cypress.env('Project_API')}api/venue/list?group_id=${venuesGroupData[0]?.id}&limit=10&offset=20&order_by=name&direction=asc&status=2`,
      {
        success: true,
        data: {
          total: venuesGroupListData.length,
    ...
    cy.intercept(
      'GET',
      `${Cypress.env('Project_API')}api/venue/list?group_id=${venuesGroupData[0]?.id}&limit=10&offset=0&order_by=name&direction=asc&status=1`,
      {
        success: true,
        data: {
          total: venuesGroupListData.length,
    ...
    ).as('getPendingGroupedVenues');

    cy.intercept(
      'GET',
      `${Cypress.env('Project_API')}api/venue/list?group_id=${venuesGroupData[0]?.id}&limit=10&offset=10&order_by=name&direction=asc&status=1`,
      {
        success: true,
        data: {
          total: venuesGroupListData.length,
    ...
    ).as('getPendingGroupedVenues2');

    cy.intercept(
      'GET',
      `${Cypress.env('Project_API')}api/venue/list?group_id=${venuesGroupData[0]?.id}&limit=10&offset=20&order_by=name&direction=asc&status=1`,
      {
        success: true,
        data: {
          total: venuesGroupListData.length,
  ...
  it('should update venue', () => {
    cy.intercept(`/resources/venues/items/${venuesGroupListData[0]?.id}`, {
      success: true,
    ...
    cy.intercept(
      `${Cypress.env('Project_API')}api/venue/?venue_id=${venuesGroupListData[0]?.id}`,
      {
        success: true,
        data: {
          ...venuesGroupListData[0],
    ...
    cy.intercept(
      `${Cypress.env('Project_API')}api/group/?group_id=${venuesGroupData[0]?.id}`,
      {
        success: true,
        data: {
          ...venuesGroupData[0],
    ...
    cy.wait('@getPendingGroupedVenues');
    cy.wait(500);
  ...
  it('should create a new venue group', () => {
    cy.intercept('POST', `${Cypress.env('Project_API')}api/group`, {
      success: true,
      data: {
        id: 'Group_New',
      },
    ...
    cy.intercept(
      'GET',
      `${Cypress.env('Project_API')}api/group/?group_id=Group_New`,
      {
        success: true,
        data: {
          id: 'Group_New',
  ...
  it('should sort venues by name and change sort directions', () => {
    cy.intercept(
      'GET',
      `${Cypress.env('Project_API')}api/group/list?limit=9&offset=0&order_by=name&direction=desc&status=2`,
      {
        success: true,
        data: {
          total: venuesGroupData.length,
    ...
    cy.intercept(
      'GET',
      `${Cypress.env('Project_API')}api/group/list?limit=10&offset=9&order_by=name&direction=desc&status=2`,
      {
        success: true,
        data: {
          total: venuesGroupData.length,
    ...
    cy.intercept(
      'GET',
      `${Cypress.env('Project_API')}api/group/list?limit=10&offset=19&order_by=name&direction=desc&status=2`,
      {
        success: true,
        data: {
          total: venuesGroupData.length,
    ...
    cy.intercept(
      'GET',
      `${Cypress.env('Project_API')}api/venue/list?group_id=${venuesGroupData[venuesGroupData.length - 1]?.id}&limit=10&offset=0&order_by=name&direction=desc&status=2`,
      {
        success: true,
        data: {
          total: venuesGroupListData.length,
  ...
  it('should search for a venue by name', () => {
    cy.intercept(
      `${Cypress.env('Project_API')}api/group/list?limit=10&offset=0&order_by=name&direction=asc&search=Venue%201&status=2`,
      {
        success: true,
        data: {
          total: venuesGroupData.length,
    ...
    cy.intercept(
      `${Cypress.env('Project_API')}api/venue/search?limit=10&offset=0&order_by=name&direction=asc&search=Venue%201&status=2`,
      {
        success: true,
        data: {
          total: 1,
    ...
    cy.intercept(
      `${Cypress.env('Project_API')}api/venue/list?limit=10&offset=0&order_by=name&direction=asc&search=Venue%201&status=2`,
      {
        success: true,
        data: {
          total: 1,
  ...
  it('should drag and drop a venue to a group', () => {
    cy.intercept('PUT', `${Cypress.env('Project_API')}api/venue/toggle`, {
      success: true,
      data: null,
    }).as('toggleVenues');
