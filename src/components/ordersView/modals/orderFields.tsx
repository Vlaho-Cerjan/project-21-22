...
export default function OrderFields({
  ...
  formData: OrdersUpdateData | null;
  setFormData: React.Dispatch<React.SetStateAction<OrdersUpdateData | null>>;
  oldAddress: {
            ...
            textareaProps={{
              ...
              onChange: (e) => {
                setFormData({
                  ...(formData as OrdersUpdateData),
                  notes: {
                    ...(formData as OrdersUpdateData).notes,
