...
import MemoGridLayout from '@/src/icons/grid-layout';
  ...
  return (
    <div className="folderViewContentHeader">
      ...
      <div className="rightContainer">
        ...
        <IconButton
          className="gridListButton"
          onClick={() => setIsGrid(!isGrid)}
          icon={<MemoGridLayout className={isGrid ? 'grid' : 'list'} />}
          data-tooltip-id="gridTooltip"
          data-tooltip-content={isGrid ? 'Grid View On' : 'Grid View Off'}
        />
      </div>
    </div>
  );
