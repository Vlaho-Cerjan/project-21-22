...
import ModalTextAreaLabel from '@/src/components/common/modalTextAreaLabel/modalTextAreaLabel';
...
export default function Information({
  ...
  //setBillingData: React.Dispatch<React.SetStateAction<OrdersAdminCreateData>>;
        ...
        */}
        ...
        <div className="row">
          <ModalSelectLabelFuzzy
            inputTestId="orderCountryCodeDropdown"
            labelText="Country"
            ...
            setValue={(data) => {
              setShippingData({
                ...shippingData,
                shipping_country_code: data.id as string,
              });
            }}
            dataName="Countries"
          />
      ...
      <div className="formContainer">
        <ModalTextAreaLabel
          ...
          textareaProps={{
            ...
            value: shippingData?.notes?.order_notes || '',
            onChange: (e) => {
              setShippingData({
                ...shippingData,
                notes: {
