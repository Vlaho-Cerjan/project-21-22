...
export default function CreateNewPlaylistModal({
  ...
  onSubmit: (data: {name: string; videos: BackendVideoData[]}) => void;
}) {
  ...
  return (
    <div>
      <Modal
        className="actionPlaylistModal fullWidth fullHeight"
        open={open}
        setOpen={setOpen}
      >
        <ModalHeader
        ...
        <ModalFooter
          ...
          modalClass="actionPlaylistModal"
          buttonText="Create Playlist"
          loadingText="Creating ..."
          successText="Playlist Created"
          errorText="Error"
          onSubmit={() => {
            onSubmit({
              name: playlistName,
