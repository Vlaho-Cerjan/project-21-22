...
export default function DenyModal({
  ...
  onSubmit: () => Promise<'error' | 'success'>;
  itemCount: number;
  data:
  ...
  */
  ...
  React.useEffect(() => {
    setDenyNote((data && data.notes.order_notes) || '');
  }, []);
  ...
  return (
    <div>
      <Modal className="denyModal" open={open} setOpen={setOpen}>
        ...
        <ModalFooter
          setOpen={setOpen}
          backDataTestId="denyOrderBack"
          submitDataTestId="denyOrderSubmit"
          isError={isError}
