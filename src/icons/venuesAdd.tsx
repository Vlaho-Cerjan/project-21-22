...
function VenuesAdd(props: React.SVGProps<SVGSVGElement>) {
  return (
    <svg width="1em" height="1em" viewBox="0 0 24 24" fill="none" {...props}>
      <g stroke="#323234" strokeWidth={1.5} strokeLinecap="round">
        <path d="M12 19H4" strokeLinejoin="round" />
        <path
          clipRule="evenodd"
        ...
        />
        <path
          d="M5.927 19v-6M10 19v-5.988M19.914 9H4.086"
          strokeLinejoin="round"
        />
...
const MemoVenuesAdd = React.memo(VenuesAdd);
export default MemoVenuesAdd;
